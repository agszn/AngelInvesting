...
# unlisted_stock_marketplace/admin.py
from django import forms
from django.utils.safestring import mark_safe
from .models import Report
from .format_utils import render_custom_format

# ✅ Step 1: Create custom form for Report
from django import forms
from django.utils.safestring import mark_safe
from .models import Report
...
class ReportForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Optional: Resize the summary input
...
class ReportAdmin(admin.StackedInline):
    ...
    extra = 1
    classes = ['collapse']
    readonly_fields = ('render_formatting_guide', 'rendered_summary')

    # ✅ Live preview of rendered summary
    def rendered_summary(self, obj):
        if obj and obj.summary:
            return mark_safe(f"""
                <div style="border:1px solid #ccc; padding:10px; background:#f9f9f9;">
                    <strong>Live Preview:</strong><br><br>
                    {render_custom_format(obj.summary)}
                </div>
            """)
        return "-"

    rendered_summary.short_description = "Formatted Summary Preview"

    # ✅ Formatting guide on the right side
    def render_formatting_guide(self, obj=None):
        return mark_safe("""
            <div style="padding: 10px; font-size: 14px; background: #eef7ff; border: 1px solid #b3d4fc;">
                <strong>📝 Formatting Guide:</strong><br>
                <ul style="margin-top: 5px; padding-left: 20px;">
                  <li><code>## Heading</code> – Heading (24px)</li>
                  <li><code>### Subheading</code> – Subheading (20px)</li>
                  <li><code>**bold**</code> – Bold text</li>
                  <li><code>!!italic!!</code> – Italic text</li>
                  <li><code>~~underline~~</code> – Underlined text</li>
                  <li><code>>></code> & <code><<</code> – Start/end of bullet list</li>
                  <li><code>//</code> & <code>\\\\</code> – Start/end of numbered list</li>
                  <li><code>|| List item ||</code> – Bullet or number item</li>
                </ul>
            </div>
        """)

    render_formatting_guide.short_description = "Formatting Help"





# non formated overview
...
#     def rendered_company_overview(self, obj):
#         if obj.company_overview:
#             return mark_safe(render_custom_format(obj.company_overview))
#         return "-"
#     rendered_company_overview.short_description = "Company Overview (Preview)"
...
from django import forms
from django.contrib import admin
from .models import StockData, Report
from .format_utils import render_custom_format
...
class StockDataForm(forms.ModelForm):
            ...
            'company_overview': mark_safe("""
                <div style="padding: 10px; font-size: 14px; background: #eef7ff; border: 1px solid #b3d4fc;">
                    ...
                    <ul style="margin-top: 5px; padding-left: 20px;">
                        ...
                        <li><code>>></code> & <code><<</code> – Start/end of bullet list</li>
                        <li><code>//</code> & <code>\\\\</code> – Start/end of numbered list</li>
                        <li><code>|| List item ||</code> – Bullet/numbered list item</li>
                    </ul>
                </div>
            """)
        }
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['company_overview'].widget.attrs.update({
            'rows': 8,
            'style': 'width: 100%; font-family: monospace;'
        })
...
class StockDataAdmin(admin.ModelAdmin):
    ...
    # ✅ Only the preview method is read-only
    # form = StockDataForm
    # readonly_fields = ('rendered_company_overview',)
    ...
    fieldsets = (
        ...
        ('🏢 Company Description', {
            'fields': (
                'registered_office_address', 'transfer_agent_address',
                'description', 
                'company_overview',  # ✅ Editable input field
                'rendered_company_overview',  # ✅ Preview (readonly)
                'logo'
            ),
            'description': 'Narrative and visual branding of the company.'
        }),
    ...
    # special char formating overview start 
    # def rendered_company_overview(self, obj):
    #     if obj.company_overview:
    #         return mark_safe(render_custom_format(obj.company_overview))
    #     return "-"
    # rendered_company_overview.short_description = "Company Overview (Preview)"
    # special char formating overview end 
# part 3
